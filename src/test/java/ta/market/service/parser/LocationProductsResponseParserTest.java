package ta.market.service.parser;
...
public class LocationProductsResponseParserTest {
    ...
    @Before
    public void setUp() {
        response.put(LocationFixture.ITEMS_KEY, buildResponseItems());
    }
    ...
    private JSONArray buildResponseItems() {
        ...
        item.put(LocationFixture.NAME_KEY, NAME_VALUE);
        item.put(LocationFixture.PRICE_KEY, PRICE_VALUE);
